...
/**
 * Provides a form for reverting a Auction Items revision.
 *
 * @ingroup auctions_core
 */
class AuctionItemRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'auction_item_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Auction Items: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    $this->messenger()->addMessage($this->t('Auction Items %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\auctions_core\Entity\AuctionItemInterface $revision
   ...
   */
  protected function prepareRevertedRevision(AuctionItemInterface $revision, FormStateInterface $form_state) {
