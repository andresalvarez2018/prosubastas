...
prosubastas theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of prosubastas theme and run the following commands:
`nvm use`
...
`drush en prosubastas -y`
`drush config-set system.theme default prosubastas -y`
